...
<div class="container">
    ...
    <div class="row mb-4">
        ...
        <?php foreach($featured as $product): $price = convertPrice($product['price_usd'], $currentCurrency); $compare = $product['compare_price_usd'] ? convertPrice($product['compare_price_usd'], $currentCurrency) : null; $img = $product['images_array'][0]; ?>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <div class="product-rating">
                        ...
                        <span>(<?php echo $product['rating_count'] ?: rand(10, 500); ?>)</span>
                    </div>
                    <div class="mt-2">
                        <button class="btn btn-primary btn-sm w-100 quick-add-cart" data-id="<?php echo $product['id']; ?>">
    ...
    <div class="row mb-4">
        ...
        <?php foreach($sale as $product): $price = convertPrice($product['price_usd'], $currentCurrency); $compare = convertPrice($product['compare_price_usd'], $currentCurrency); $img = $product['images_array'][0]; ?>
        <div class="col-md-3 col-6">
            <div class="product-card">
                ...
                <div class="product-info">
                    <div class="product-title"><a href="product.php?slug=<?php echo $product['slug']; ?>"><?php echo $product['name']; ?></a></div>
                    <div class="product-price"><?php echo formatPrice($price); ?>
                        <span class="product-old-price"><?php echo formatPrice($compare); ?></span>
                    </div>
                    <div class="mt-2">
                        <button class="btn btn-primary btn-sm w-100 quick-add-cart" data-id="<?php echo $product['id']; ?>">
                            <i class="fas fa-cart-plus"></i> Add to Cart
    ...
    <div class="row mb-4">
        ...
        <?php foreach($trending as $product): $price = convertPrice($product['price_usd'], $currentCurrency); $img = $product['images_array'][0]; ?>
        <div class="col-md-3 col-6">
            <div class="product-card">
                <div class="product-image">
                    <img src="assets/uploads/<?php echo $img; ?>" onerror="this.src='https://via.placeholder.com/200'">
